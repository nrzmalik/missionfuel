(function() {
    ...
    class TranslationWidget {
        ...
        // ... rest of your TranslationWidget class implementation ...
        ...
        applyCustomStyles() {
            ...
            // Essential CSS that's always included
            const essentialCSS = `
            ...
            // Optional CSS for select box styling
            const customCSS = this.config.useCustomCSS ? `
                .goog-te-combo {
            ...
            style.textContent = essentialCSS + customCSS;
